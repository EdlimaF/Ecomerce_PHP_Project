...
<head>
  ...
  <title>Lojas Lima & Cia. | Iniciar</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/res/admin/index2.html" class="logo">
      ...
      <span class="logo-mini"><b>L</b>LC</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Lojas </b>Lima & Cia.</span>
    </a>
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      ...
                      <!-- The message -->
                      <p>No caso de dúvidas entre em contato.</p>
                    </a>
                  </li>
                  <!-- end message -->
                </ul>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo getUserLogin(); ?></span>
            </a>
            <ul class="dropdown-menu">
