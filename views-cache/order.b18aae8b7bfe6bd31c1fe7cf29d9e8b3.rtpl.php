...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>Lojas Lima & Cia.</strong><br>
                Rua Sem referencia, 000 - Bairro<br>
                Cidade - EST<br>
            ...
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
            <b>Pedido Nº<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></b><br>
            <br>
            <b>Emitido em:</b> <?php echo formatDate($order["dtregister"]); ?><br>
            <b>Pago em:</b> <?php echo formatDate($order["dtregister"]); ?><br>
            <b>Status:</b> <?php echo htmlspecialchars( $order["desstatus"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
            </div>
            <!-- /.col -->
        </div>
        <!-- /.row -->
