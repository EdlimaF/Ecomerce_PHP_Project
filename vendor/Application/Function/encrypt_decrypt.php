<?php
	...
	*/
	...
	$plain_txt = "Edvaldo lima Filho";
	echo "Plain Text =" .$plain_txt. "<br>\n";

	$encrypted_txt = encrypt_decrypt('encrypt', $plain_txt, 'meu key', 'meu iv');
	echo "Encrypted Text = " .$encrypted_txt. "<br>\n";

	$decrypted_txt = encrypt_decrypt('decrypt', $encrypted_txt, 'meu key', 'meu iv');
