...
// | Desenvolvimento Boleto NossaCaixa: Keitty Su?en                  	  |
// +----------------------------------------------------------------------+
?>
...
<span class="ld2">
&nbsp;&nbsp;&nbsp;&nbsp;Linha Digit?el: &nbsp;<?php echo $dadosboleto["linha_digitavel"]?><br>
...
Outros acr?cimos</td><td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>(=) 
...
documento</td><td class=ct valign=top width=7 height=13> <img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=62 height=13>Esp?ie 
...
<img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=53 height=13>Esp?ie</td><td class=ct valign=top height=13 width=7> 
...
<td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>C?. 
